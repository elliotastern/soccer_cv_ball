...
Same structure as v2_20_epochs_sub_synth but uses SAHI (Slicing Aided Hyper Inference) for better tiny object detection
"""
import cv2
import numpy as np
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Analyze frames with SAHI')
    parser.add_argument('--num-frames', type=int, default=20, help='Number of frames to analyze (default: 20 for quick test)')
